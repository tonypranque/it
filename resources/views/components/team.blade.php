        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            @foreach([
              [
                ...
                'social' => ['telegram' => '#', 'email' => 'mailto:anton@itpro.com']
              ],
              [
                'name' => 'Елена Смирнова',
                'role' => 'Специалист по 1С',
                'img' => '/img/team/elena.jpg',
                'social' => ['telegram' => '#', 'email' => 'mailto:elena@itpro.com']
              ],
              [
                'name' => 'Дмитрий Козлов',
                'role' => 'Руководитель технической поддержки',
                'img' => '/img/team/dmitry.jpg',
                'social' => ['telegram' => '#', 'email' => 'mailto:dmitry@itpro.com']
              ],
            ] as $index => $member)
                <div
                    x-data="{ inView: false }"
