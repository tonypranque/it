...
@extends('layouts.app', ['breadcrumbItems' => $breadcrumbItems ?? []]) {{-- Передаем хлебные крошки в layout --}}
            ...
            <div class="container mx-auto px-4 relative z-10">
                ...
                >
                    ...
                    <div class="inline-block mb-4">
                        <span class="code-highlight">// Services</span> {{-- Исправлено, так как $service не определен на этой странице --}}
                    </div>
                    ...
                    <p class="text-lg text-muted-foreground leading-relaxed">
                        Профессиональные решения для вашего бизнеса. {{-- Исправлено, так как $service не определен на этой странице --}}
                    </p>
                </div>
            </div>
        </section>
